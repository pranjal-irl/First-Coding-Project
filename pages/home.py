...
st.page_link("pages/project1.py", title="Know your Favourite Programming Language", icon="1️⃣")
st.page_link("pages/project2.py", title="Know about your Coding Level", icon="2️⃣")